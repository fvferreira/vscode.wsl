---
title: "Guia: Configurando WSL/Ubuntu + GCC + VS Code no Windows"
lang: pt-BR
description: "Um guia passo a passo para configurar um ambiente de desenvolvimento C completo no Windows usando WSL (Ubuntu), o compilador GCC e o editor VS Code."
...
## 2. Guia de Instalação e Configuração (Passo a Passo)
...
4.  Após a conclusão, **reinicie o seu computador**.
5.  Ao reiniciar, o Ubuntu será iniciado pela primeira vez para finalizar a configuração. Você precisará criar um **nome de usuário** e uma **senha** para o seu ambiente Linux. (Nota: Esta senha não tem relação com sua senha do Windows).
...
Com WSL, Ubuntu, GCC e VS Code, você não precisa mais "emular" um ambiente de desenvolvimento C no Windows. Você está essencialmente usando um ambiente Linux completo e profissional, totalmente integrado ao seu editor de código.
...
* Algumas aplicações via Ia gemini, com formatação em `.md` "box cod, conceitos..."